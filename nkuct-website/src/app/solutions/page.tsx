  ...
  const solutions = [
    {
      ...
      icon: <Cpu size={40} />,
      title: '반도체 장비 소화 시스템',
      desc: 'CVD, Etcher, Implanter 등 반도체 핵심 생산 장비 내부의 화재를 초기에 감지하고 진압하는 맞춤형 자동소화 시스템입니다.',
      features: [
    ...
    },
    {
      ...
      icon: <Wind size={40} />,
      title: '클린룸 특화 방재',
      desc: '친환경 이산화탄소(CO2) 소화약제를 사용하여 Class 1~100 수준의 엄격한 클린룸 환경에 최적화된 고청정 방재 시스템입니다.',
      features: [
