  ...
  const solutions = [
    {
      ...
      icon: <Cpu size={40} />,
      title: '반도체 장비 소화 시스템',
      desc: '반도체 핵심 생산 장비 내부의 화재를 초기에 감지하고 진압하는 맞춤형 자동소화 시스템입니다.',
      features: [
        '0.3초 이내 초고속 화재 감지 및 이산화탄소(CO2) 소화약제 방사',
        '장비별 독립적 개별 방호 시스템 구축',
    ...
    },
    {
      ...
      title: '디스플레이 라인 방호',
      desc: 'LCD, OLED 등 대면적 패널 공정 라인의 고온 환경과 유기용제 사용에 특화된 화재 방호 전용 시스템입니다.',
      features: [
    ...
    },
    {
      ...
      title: 'ESS 화재 방호',
      desc: '리튬이온 배터리 에너지저장장치(ESS)의 열폭주를 조기에 감지하고 화재 확산을 원천적으로 억제하는 스마트 방호 시스템입니다.',
      features: [
    ...
    },
    {
      ...
      icon: <Wind size={40} />,
      title: '클린룸 특화 방재',
      desc: '친환경 이산화탄소(CO2) 소화약제를 사용하여 클린룸 환경에 최적화된 고청정 방재 시스템입니다.',
      features: [
    ...
    },
    {
      ...
      icon: <Flame size={40} />,
      title: '배기덕트 소화 시스템',
      desc: '특수 서미스터 열 감지기를 연동하여 가연성 부산물이 축적되기 쉬운 배기덕트 화재를 조기 감지하고 연기 확산을 차단합니다.',
      features: [
              ...
              <AnimateOnScroll key={solution.id} animation="fade-in-up" delay={index * 100}>
                <div id={solution.id} className="glass-card overflow-hidden">
                  <div className="flex flex-col">
                    {/* Full content */}
                    <div className="p-8 md:p-10 w-full flex flex-col items-center text-center">
